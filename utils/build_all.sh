...
sudo docker push kaiaai/kaiaai:humble >> push_humble.log && sudo docker tag kaiaai/kaiaai:humble kaiaai/kaiaai-ros-dev:humble && sudo docker push kaiaai/kaiaai-ros-dev:humble &
