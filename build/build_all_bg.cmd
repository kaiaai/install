...
START docker push kaiaai/kaia-ros:humble
docker image rm kaiaai/kaia-ros:iron
docker build --no-cache -t kaiaai/kaia-ros:iron --build-arg distro_tag=iron .
START docker push kaiaai/kaia-ros:iron
